...
vim.keymap.set('n', '<leader><leader>lt', ':split | terminal cd ~/Projects/so && valet php artisan tinker<cr>i')
...
vim.keymap.set('n', '<leader>la', function ()
    input({
        ...
        callback = function (command)
            ...
            vim.cmd('split | terminal valet php artisan ' .. command)
        end
    })
end)
...
vim.keymap.set('n', '<leader><leader>tv', function ()
    input({
        prompt = 'Command',
        callback = function (command)
